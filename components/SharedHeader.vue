...
<template>
  <header class="w-full p-3 flex flex-row justify-between items-center sticky top-0 z-999 border-b border-default backdrop-blur-xl">
    ...
    <div class="flex flex-row items-center">
      ...
      <div class="flex flex-row items-center md:ml-6 md:pl-6 md:border-l md:border-default gap-x-2">
